...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <center>Input Bagian Prakerin</center>
      </h1>
    </section>
            ...
            <div class="box-body">
              <form role="form" action="#" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_bagian" required="required">
                </div>
                <div class="form-group">
                  <label>Kuota</label>
                  <input type="text" class="form-control" name="kuota" required="required">
                </div>                
                <div class="form-group">
                  <label>Max</label>
                  <input type="text" class="form-control" name="max" required="required">
                </div>
                <div class="form-group">
                  <label>Pembimbing</label>
                  <input type="text" class="form-control" name="pembimbing" required="required">
                </div>
