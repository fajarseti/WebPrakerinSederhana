      ...
      <div class="row">
          ...
          <div class="box box-solid">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-square" src="dist/img/efen.jpg" alt="User profile picture">

              <h3 class="profile-username text-center">Efen Andira Sara Shova</h3>

              <br>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>NIM</b> <a class="pull-right">A12.2014.05096</a>
                </li>
                <li class="list-group-item">
                  <b>Jurusan</b> <a class="pull-right">Sistem Informasi</a>
                </li>
                <li class="list-group-item">
                  <b>Fakultas</b> <a class="pull-right">Ilmu Komputer</a>
                </li>
                <li class="list-group-item">
                  <b>Instansi</b> <a class="pull-right">Universitas Dian Nuswantoro</a>
                </li>
              </ul>
            </div>
            <!-- /.box-body -->
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><b>About Me</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <p class="text-muted">
                B.S. in Computer Science from the University of Dian Nuswantoro
              </p>
              ...
              <p class="text-muted">Semarang, Indonesia</p>
