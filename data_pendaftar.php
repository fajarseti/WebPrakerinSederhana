...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <center>Data Peserta Pendaftar</center>
      </h1>
    </section>
    <section class="content-header">
      <div class="pull-right"><a href="pendaftar.php"><button type='submit' class='fa fa-plus btn btn-success' style="margin-top: -30px;"> Tambah Data</button></a></div>
    </section>
  ...
  <tr bgcolor=#39CCCC>
    ...
    <th><center>Nomor Instansi</center></th>
