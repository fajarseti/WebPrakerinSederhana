...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <center>Edit Bagian Prakerin</center>
      </h1>
    </section>
            ...
            <div class="box-body">
              <form role="form" action="#" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_bagian" value="" required="required">
                  <input type="hidden" name="" value=""></input>
                </div>
                <div class="form-group">
                  <label>Kuota</label>
                  <input type="text" class="form-control" name="kuota" value="" required="required">
                  <input type="hidden" name="" value=""></input>
                </div>                
                <div class="form-group">
                  <label>Max</label>
                  <input type="text" class="form-control" name="max" value="" required="required">
                  <input type="hidden" name="" value=""></input>
                </div>
                <div class="form-group">
                  <label>Pembimbing</label>
                  <input type="text" class="form-control" name="pembimbing" value="" required="required">
                  <input type="hidden" name="" value=""></input>
                </div>
                <div class="box-footer">
                  <input type="submit" class="btn btn-primary" value="Simpan">
              </form>
                  <a href="data_bidangprak.php"><input type="button" class="btn btn-danger" value="Kembali"></a>
            </div>
          </div>
    </section>
  </div>
