...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <center>Input Peserta Pendaftar</center>
      </h1>
    </section>
            ...
            <div class="box-body">
              <form role="form" action="#" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_panggilan" required="required">
                </div>                
                <div class="form-group">
                  <label>Alamat</label>
                ...
                <div class="form-group">
                  <label>Wali Pendaftar</label>
                  <input type="text" class="form-control" name="wali" required="required">
                </div>
                <div class="form-group">
                  <label>Nomor Instansi</label>
                  <input type="text" class="form-control" name="no_instansi" required="required">
                </div>                
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control pull-right" id="tgl_lahir" name="tgl_lahir" data-date-format="yyyy-mm-dd">
                </div>
                </div>
                <div class="form-group">
                ...
                <div class="box-footer">
                  ...
                  <a href="data_pendaftar.php"><input type="button" class="btn btn-danger" value="Kembali"></a>
            </div>
          </div>
    </section>
  </div>
